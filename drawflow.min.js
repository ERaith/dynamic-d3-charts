            ...
            class s {
                ...
                start() {
                    this.container.classList.add("parent-drawflow"),
                        ...
                        (this.container.onpointerup = this.pointerup_handler.bind(
                            this
                        )),
                        (this.container.onpointercancel = this.pointerup_handler.bind(
                            this
                        )),
                        (this.container.onpointerout = this.pointerup_handler.bind(
                            this
                        )),
                        (this.container.onpointerleave = this.pointerup_handler.bind(
                            this
                        )),
                        this.load();
                }
                ...
                click(e) {
                    if (
                        ...
                        (this.first_click = e.target),
                            ...
                            null !=
                                e.target.closest(".drawflow_content_node") &&
                                (this.ele_selected = e.target.closest(
                    ...
                    switch (this.ele_selected.classList[0]) {
                        case "drawflow-node":
                            null != this.node_selected &&
                                (this.node_selected.classList.remove(
                                    "selected"
                                ),
                        ...
                        case "main-path":
                            ...
                            const t = this.connection_selected.parentElement
                                .classList;
                ...
                position(e) {
                    ...
                    if (
                        ...
                        this.editor_selected &&
                            ((s = this.canvas_x + -(this.pos_x - t)),
                            (i = this.canvas_y + -(this.pos_y - n)),
                            this.dispatch("translate", { x: s, y: i }),
                        ...
                        (this.pos_x = t),
                            ...
                            (this.ele_selected.style.top =
                                this.ele_selected.offsetTop - i + "px"),
                            (this.ele_selected.style.left =
                                this.ele_selected.offsetLeft - s + "px"),
                            (this.drawflow.drawflow[this.module].data[
                                this.ele_selected.id.slice(5)
                            ].pos_x = this.ele_selected.offsetLeft - s),
                            (this.drawflow.drawflow[this.module].data[
                                this.ele_selected.id.slice(5)
                            ].pos_y = this.ele_selected.offsetTop - i),
                    ...
                    if (this.drag_point) {
                        ...
                        const e = this.ele_selected.parentElement.classList[2].slice(
                                9
                            ),
                            c = this.ele_selected.parentElement.classList[1].slice(
                                13
                            ),
                        ...
                        let r =
                            Array.from(
                                this.ele_selected.parentElement.children
                            ).indexOf(this.ele_selected) - 1;
                        if (this.reroute_fix_curvature) {
                            (r -=
                                this.ele_selected.parentElement.querySelectorAll(
                                    ".main-path"
                                ).length - 1),
                                r < 0 && (r = 0);
                        }
                        const h = e.slice(5),
                            u = this.drawflow.drawflow[this.module].data[
                                h
                            ].outputs[d].connections.findIndex(function (e, t) {
                                return e.node === c && e.output === a;
                            });
                        this.drawflow.drawflow[this.module].data[h].outputs[
                            d
                        ].connections[u].points[r] = { pos_x: o, pos_y: l };
                        const p = this.ele_selected.parentElement.classList[2].slice(
                            9
                        );
                        this.updateConnectionNodes(p);
                    }
                    "touchmove" === e.type &&
                        ((this.mouse_x = t), (this.mouse_y = n)),
                ...
                dragEnd(e) {
                    ...
                    else (t = e.clientX), (n = e.clientY), (s = e.target);
                    if (
                        (this.drag &&
                        ...
                        if (
                            ...
                            (this.force_first_input &&
                                (null != s.closest(".drawflow_content_node") ||
                                    "drawflow-node" === s.classList[0]))
                        ) {
                            if (
                                !this.force_first_input ||
                                (null == s.closest(".drawflow_content_node") &&
                                ...
                                if (null != s.closest(".drawflow_content_node"))
                                    var i = s.closest(".drawflow_content_node")
                                        .parentElement.id;
                                else var i = s.id;
                                if (
                                    0 ===
                                    Object.keys(
                                        this.getNodeFromId(i.slice(5)).inputs
                                    ).length
                                )
                                    var o = !1;
                                else var o = "input_1";
                            }
                            var l = this.ele_selected.parentElement
                                    .parentElement.id,
                            ...
                            if (l !== i && !1 !== o) {
                                if (
                                    ...
                                    this.drawflow.drawflow[this.module].data[
                                        a
                                    ].outputs[c].connections.push({
                                        node: d,
                                        output: o,
                                    }),
                                        this.drawflow.drawflow[
                                            this.module
                                        ].data[d].inputs[o].connections.push({
                                            node: a,
                                            input: c,
                                        }),
                ...
                contextmenu(e) {
                    ...
                    if (
                        ...
                        t.classList.add("drawflow-delete"),
                            (t.innerHTML = "x"),
                            this.node_selected &&
                                this.node_selected.appendChild(t),
                            this.connection_selected &&
                                ((t.style.top =
                                    e.clientY *
                                        (this.precanvas.clientHeight /
                ...
                contextmenuDel() {
                    this.precanvas.getElementsByClassName("drawflow-delete")
                        .length &&
                        this.precanvas
                            .getElementsByClassName("drawflow-delete")[0]
                            .remove();
                ...
                zoom_refresh() {
                    this.dispatch("zoom", this.zoom),
                        (this.canvas_x =
                            (this.canvas_x / this.zoom_last_value) * this.zoom),
                        (this.canvas_y =
                            (this.canvas_y / this.zoom_last_value) * this.zoom),
                ...
                zoom_in() {
                    this.zoom < this.zoom_max &&
                        ((this.zoom += this.zoom_value), this.zoom_refresh());
                }
                zoom_out() {
                ...
                addConnection(e, t, n, s) {
                    ...
                    if (i === this.getModuleFromNodeId(t)) {
                        ...
                        if (!1 === l) {
                            if (
                                (this.drawflow.drawflow[i].data[e].outputs[
                                    n
                                ].connections.push({
                                    node: t.toString(),
                                    output: s,
                                }),
                                this.drawflow.drawflow[i].data[t].inputs[
                                    s
                                ].connections.push({
                                    node: e.toString(),
                                    input: n,
                        ...
                        if (null === p[t].querySelector(".point")) {
                            var f = document.getElementById(e),
                                ...
                                w =
                                    ...
                                    (g.getBoundingClientRect().y -
                                        ...
                                        u,
                                v = f.querySelectorAll(
                                    "." + p[t].classList[3]
                                )[0],
                                y =
                                    v.offsetWidth / 2 +
                                    (v.getBoundingClientRect().x -
                                        s.getBoundingClientRect().x) *
                                        h,
                                C =
                                    v.offsetHeight / 2 +
                                    (v.getBoundingClientRect().y -
                                        s.getBoundingClientRect().y) *
                                        u;
                            ...
                            n.forEach((t, d) => {
                                if (0 === d && n.length - 1 == 0) {
                                    ...
                                    (i += v), f.push(v);
                                    p = t;
                                    var y = t.parentElement.classList[1].replace(
                                            "node_in_",
                                            ""
                                        ),
                                        C = (E = document.getElementById(
                                            y
                                        )).querySelectorAll(
                                    ...
                                    var E, L;
                                    (p = t),
                                        (y = t.parentElement.classList[1].replace(
                                            "node_in_",
                                            ""
                                        )),
                                        (C = (E = document.getElementById(
                                ...
                                d
                                    ? f.forEach((e, n) => {
                                          p[t].children[n].setAttributeNS(
                                              null,
                                              "d",
                                              e
                                          );
                                      })
                                    : p[t].children[0].setAttributeNS(
                                          null,
                                          "d",
                                          i
                                      );
                    ...
                    Object.keys(f).map(function (t, n) {
                        if (null === f[t].querySelector(".point")) {
                            var r = document.getElementById(e),
                                ...
                                g =
                                    m.offsetWidth / 2 +
                                    (m.getBoundingClientRect().x -
                                        s.getBoundingClientRect().x) *
                                        h,
                                _ =
                                    m.offsetHeight / 2 +
                                    (m.getBoundingClientRect().y -
                                        s.getBoundingClientRect().y) *
                                        u,
                                w =
                                    (r = r.querySelectorAll(
                                        ...
                                        2 +
                                    (r.getBoundingClientRect().x -
                                        s.getBoundingClientRect().x) *
                                        h,
                                v =
                                    r.offsetHeight / 2 +
                                    (r.getBoundingClientRect().y -
                                        s.getBoundingClientRect().y) *
                                        u;
                            ...
                            n.forEach((t, d) => {
                                if (0 === d && n.length - 1 == 0) {
                                    ...
                                    (i += w), r.push(w);
                                    p = t;
                                    var v = t.parentElement.classList[2].replace(
                                            "node_out_",
                                            ""
                                        ),
                                        y = (x = document.getElementById(
                                            v
                                        )).querySelectorAll(
                                            "." + t.parentElement.classList[3]
                                        )[0];
                                    ...
                                    var C;
                                    (p = t),
                                        (v = t.parentElement.classList[2].replace(
                                            "node_out_",
                                            ""
                                        )),
                                        (y = (x = document.getElementById(
                                    ...
                                    var x, E;
                                    (p = t),
                                        (v = t.parentElement.classList[1].replace(
                                            "node_in_",
                                            ""
                                        )),
                                        (y = (x = document.getElementById(
                                ...
                                d
                                    ? r.forEach((e, n) => {
                                          f[t].children[n].setAttributeNS(
                                              null,
                                              "d",
                                              e
                                          );
                                      })
                                    : f[t].children[0].setAttributeNS(
                                          null,
                                          "d",
                                          i
                                      );
                ...
                createReroutePoint(e) {
                    ...
                    const t = this.connection_selected.parentElement.classList[2].slice(
                        ...
                        n = this.connection_selected.parentElement.classList[1].slice(
                            13
                        ),
                    ...
                    let d = 0;
                    if (this.reroute_fix_curvature) {
                        const t = e.parentElement.querySelectorAll(".main-path")
                            .length;
                        var a = document.createElementNS(
                            "http://www.w3.org/2000/svg",
                            "path"
                    ...
                    void 0 ===
                        this.drawflow.drawflow[this.module].data[r].outputs[s]
                            .connections[h].points &&
                        ...
                        this.reroute_fix_curvature
                            ? (d > 0
                                  ? this.drawflow.drawflow[this.module].data[
                                        r
                                    ].outputs[s].connections[h].points.splice(
                                        d,
                                        0,
                                        { pos_x: l, pos_y: c }
                                    )
                                  : this.drawflow.drawflow[this.module].data[
                                        r
                                    ].outputs[s].connections[h].points.push({
                                        pos_x: l,
                                        pos_y: c,
                                    }),
                              e.parentElement
                ...
                removeReroutePoint(e) {
                    ...
                    const l = t.slice(5),
                        c = this.drawflow.drawflow[this.module].data[l].outputs[
                            s
                        ].connections.findIndex(function (e, t) {
                            return e.node === n && e.output === i;
                        });
                    ...
                    this.drawflow.drawflow[this.module].data[l].outputs[
                        s
                    ].connections[c].points.splice(o, 1),
                        e.remove(),
                        this.dispatch("removeReroute", l),
                        this.updateConnectionNodes(t);
                }
                registerNode(e, t, n = null, s = null) {
                    this.noderegister[e] = { html: t, props: n, options: s };
                }
                getNodeFromId(e) {
                    var t = this.getModuleFromNodeId(e);
                    return JSON.parse(
                        JSON.stringify(this.drawflow.drawflow[t].data[e])
                    );
                }
                getNodesFromName(e) {
                    var t = [];
                    ...
                    return (
                        Object.keys(n).map(function (s, i) {
                            for (var o in n[s].data)
                                n[s].data[o].name == e &&
                                    t.push(n[s].data[o].id);
                        }),
                        t
                    );
                }
                addNode(e, t, n, s, i, o, l, c, d = !1) {
                    ...
                    if ((_.classList.add("drawflow_content_node"), !1 === d))
                        _.innerHTML = c;
                    else if (!0 === d)
                        ...
                        this.render
                            .createApp({
                                render: (e) =>
                                    this.render.h(
                                        this.noderegister[c].html,
                                        this.noderegister[c].props,
                    ...
                    Object.entries(l).forEach(function (e, t) {
                        if ("object" == typeof e[1])
                            ...
                            for (
                                var n = _.querySelectorAll("[df-" + e[0] + "]"),
                                    s = 0;
                                s < n.length;
                                s++
                            )
                ...
                addNodeImport(e, t) {
                    ...
                    o.classList.add("outputs"),
                        Object.keys(e.inputs).map(function (n, s) {
                            ...
                            o.classList.add("input"),
                                o.classList.add(n),
                                i.appendChild(o),
                                Object.keys(e.inputs[n].connections).map(
                                    function (s, i) {
                                        ...
                                        l.classList.add("main-path"),
                                            ...
                                            o.classList.add(
                                                "node_out_node-" +
                                                    e.inputs[n].connections[s]
                                                        .node
                                            ),
                                            o.classList.add(
                                                e.inputs[n].connections[s].input
                                            ),
                                            o.classList.add(n),
                                            o.appendChild(l),
                                            t.appendChild(o);
                    ...
                    if (
                        ...
                        c.appendChild(
                            this.noderegister[e.html].html.cloneNode(!0)
                        );
                    else if (3 === parseInt(this.render.version)) {
                        this.render
                            .createApp({
                                render: (t) =>
                                    this.render.h(
                                        this.noderegister[e.html].html,
                                        this.noderegister[e.html].props,
                    ...
                    Object.entries(e.data).forEach(function (t, n) {
                        if ("object" == typeof t[1])
                            ...
                            for (
                                var s = c.querySelectorAll("[df-" + t[0] + "]"),
                                    i = 0;
                                i < s.length;
                                i++
                            )
                ...
                addRerouteImport(e) {
                    ...
                    Object.keys(e.outputs).map(function (s, i) {
                        Object.keys(e.outputs[s].connections).map(function (
                            i,
                            o
                        ) {
                ...
                updateNodeDataFromId(e, t) {
                    ...
                    if (
                        ((this.drawflow.drawflow[n].data[e].data = t),
                        this.module === n)
                    ) {
                        ...
                        Object.entries(t).forEach(function (e, s) {
                            if ("object" == typeof e[1])
                                !(function e(s, i, o) {
                                    ...
                                    null !== s &&
                                        Object.entries(s).forEach(function (
                                            t,
                                            l
                                        ) {
                                            if ("object" == typeof t[1])
                ...
                addNodeInput(e) {
                    ...
                    if (this.module === t) {
                        ...
                        t.classList.add("input"),
                            ...
                            document
                                .querySelector("#node-" + e + " .inputs")
                                .appendChild(t),
                            this.updateConnectionNodes("node-" + e);
                    }
                    this.drawflow.drawflow[t].data[e].inputs[
                        "input_" + (s + 1)
                    ] = { connections: [] };
                }
                addNodeOutput(e) {
                    ...
                    if (this.module === t) {
                        ...
                        t.classList.add("output"),
                            ...
                            document
                                .querySelector("#node-" + e + " .outputs")
                                .appendChild(t),
                            this.updateConnectionNodes("node-" + e);
                    }
                    this.drawflow.drawflow[t].data[e].outputs[
                        "output_" + (s + 1)
                    ] = { connections: [] };
                }
                removeNodeInput(e, t) {
                        ...
                        this.drawflow.drawflow[n].data[t.node].outputs[
                            ...
                            if (s.node == e) {
                                ...
                                if (parseInt(c) < parseInt(o)) {
                                    ...
                                    s.points
                                        ? (this.drawflow.drawflow[n].data[
                                              t.node
                                          ].outputs[t.input].connections[i] = {
                                              node: s.node,
                                              output: "input_" + (o - 1),
                                              points: s.points,
                                          })
                ...
                removeConnection() {
                    if (null != this.connection_selected) {
                        var e = this.connection_selected.parentElement
                            .classList;
                        ...
                        var t = this.drawflow.drawflow[this.module].data[
                            ...
                            return (
                                t.node === e[1].slice(13) && t.output === e[4]
                            );
                        });
                        this.drawflow.drawflow[this.module].data[
                            e[2].slice(14)
                        ].outputs[e[3]].connections.splice(t, 1);
                        var n = this.drawflow.drawflow[this.module].data[
                            e[1].slice(13)
                        ].inputs[e[4]].connections.findIndex(function (t, n) {
                            return (
                                t.node === e[2].slice(14) && t.input === e[3]
                            );
                        });
                        this.drawflow.drawflow[this.module].data[
                            e[1].slice(13)
                        ].inputs[e[4]].connections.splice(n, 1),
                        ...
                        if (
                            ...
                            this.module === i &&
                                document
                                    ...
                                    .remove();
                            var o = this.drawflow.drawflow[i].data[e].outputs[
                                n
                            ].connections.findIndex(function (e, n) {
                                return e.node == t && e.output === s;
                            });
                            this.drawflow.drawflow[i].data[e].outputs[
                                n
                            ].connections.splice(o, 1);
                            var l = this.drawflow.drawflow[i].data[t].inputs[
                                s
                            ].connections.findIndex(function (t, s) {
                ...
                removeConnectionNodeId(e) {
                    ...
                    for (var i = s.length - 1; i >= 0; i--) {
                        var o = s[i].classList,
                            l = this.drawflow.drawflow[this.module].data[
                                o[1].slice(13)
                            ].inputs[o[4]].connections.findIndex(function (
                                e,
                                t
                            ) {
                                return (
                        ...
                        this.drawflow.drawflow[this.module].data[
                            o[1].slice(13)
                        ].inputs[o[4]].connections.splice(l, 1);
                        var c = this.drawflow.drawflow[this.module].data[
                            o[2].slice(14)
                        ].outputs[o[3]].connections.findIndex(function (e, t) {
                            return (
                                e.node === o[1].slice(13) && e.output === o[4]
                            );
                        });
                        this.drawflow.drawflow[this.module].data[
                            o[2].slice(14)
                        ].outputs[o[3]].connections.splice(c, 1),
                            s[i].remove(),
                            this.dispatch("connectionRemoved", {
                    ...
                    for (i = d.length - 1; i >= 0; i--) {
                        (o = d[i].classList),
                            (c = this.drawflow.drawflow[this.module].data[
                                o[2].slice(14)
                            ].outputs[o[3]].connections.findIndex(function (
                                e,
                                t
                            ) {
                                return (
                        ...
                        l = this.drawflow.drawflow[this.module].data[
                            ...
                            return (
                                e.node === o[2].slice(14) && e.input === o[3]
                            );
                        });
                        this.drawflow.drawflow[this.module].data[
                            o[1].slice(13)
